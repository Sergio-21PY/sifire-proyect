-- ============================================================
-- sifire_reportes.sql  |  ms-reportes  |  puerto 8082
-- FIX: estado_nuevo y todos los ENUM -> VARCHAR
-- ============================================================
DROP DATABASE IF EXISTS sifire_reportes;
CREATE DATABASE sifire_reportes CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE sifire_reportes;
...
CREATE TABLE HISTORIAL_REPORTE (
    ...
    estado_nuevo    VARCHAR(20)  NOT NULL COMMENT 'PENDIENTE | EN_PROCESO | RESUELTO | DESCARTADO',
    usuario_id      BIGINT,
