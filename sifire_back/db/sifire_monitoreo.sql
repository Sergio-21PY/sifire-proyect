-- ============================================================
-- sifire_monitoreo.sql  |  ms-monitoreo  |  puerto 8083
-- FIX: columna tipo en brigada -> VARCHAR (era ENUM)
-- ============================================================
DROP DATABASE IF EXISTS sifire_monitoreo;
CREATE DATABASE sifire_monitoreo CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
