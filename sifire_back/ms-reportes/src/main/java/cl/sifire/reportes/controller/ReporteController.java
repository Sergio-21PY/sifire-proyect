...
public class ReporteController {
    ...
    @Operation(
        summary = "Crear reporte de incendio",
        description = "Crea un nuevo reporte. El nivel de riesgo se asigna automáticamente según el tipo de reportante (Factory Method). " +
    ...
    @Operation(
        ...
        description = "Retorna todos los reportes. Se puede filtrar por estado (PENDIENTE, EN_PROCESO, RESUELTO, DESCARTADO) " +
    ...
    public ResponseEntity<List<ReporteIncendio>> listarReportes(
            @Parameter(description = "Filtrar por estado: PENDIENTE | EN_PROCESO | RESUELTO | DESCARTADO")
            @RequestParam(required = false) ReporteIncendio.EstadoReporte estado,
            @Parameter(description = "Si es 'true', retorna solo los reportes activos (no resueltos ni descartados)")
