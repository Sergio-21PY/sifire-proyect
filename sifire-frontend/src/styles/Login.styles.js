...
export const flameStyles = `
  ...
  .flame-wrap {
    ...
    filter: drop-shadow(0 0 12px #f97316) drop-shadow(0 0 6px #ef4444);
  }
  .flame {
  ...
  .flame-outer { width: 40px; height: 60px; margin-left: -20px; background: linear-gradient(to top, #ef4444, #f97316, #fbbf24); animation: flicker 1.4s ease-in-out infinite; }
  .flame-mid   { width: 26px; height: 44px; margin-left: -13px; background: linear-gradient(to top, #f97316, #fbbf24, #fef08a); animation: flicker2 1.1s ease-in-out infinite; }
  .flame-inner { width: 14px; height: 28px; margin-left: -7px;  background: linear-gradient(to top, #fef08a, #fff); animation: flicker3 0.9s ease-in-out infinite; }
`;
...
export const alertOk  = { backgroundColor: '#dcfce7', color: '#166534', padding: '0.7rem 1rem', borderRadius: C.radiusSm, fontSize: '0.85rem', textAlign: 'center', marginBottom: '1rem' };
export const alertErr = { backgroundColor: '#fee2e2', color: '#991b1b', padding: '0.7rem 1rem', borderRadius: C.radiusSm, fontSize: '0.85rem', textAlign: 'center', marginBottom: '1rem' };
