...
export const infoAlert    = { backgroundColor: '#dbeafe', color: '#1e40af', padding: '0.8rem 1.2rem', borderRadius: C.radiusSm, marginBottom: '1rem', fontWeight: 500 };
...
export const submitButton = { backgroundColor: C.red, color: '#fff', border: 'none', padding: '0.7rem 1.5rem', borderRadius: C.radiusSm, fontWeight: 600, cursor: 'pointer' };
...
export const input    = { width: '100%', padding: '0.6rem 0.8rem', borderRadius: C.radiusSm, border: `1px solid ${C.border}`, fontSize: '0.95rem', boxSizing: 'border-box', backgroundColor: C.surface, color: C.textPrimary, outline: 'none' };
export const label    = { display: 'block', fontSize: '0.85rem', fontWeight: 600, color: C.textMuted, marginBottom: '0.4rem' };
export const labelSpan = { fontWeight: 400, color: '#94a3b8', marginLeft: '0.4rem' };
...
export const dropzone      = { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: `2px dashed ${C.border}`, borderRadius: C.radiusSm, padding: '1.5rem', cursor: 'pointer', backgroundColor: C.bg, color: C.textMuted, fontSize: '0.9rem', gap: '0.4rem' };
export const dropzoneIcon  = { fontSize: '1.8rem' };
export const dropzoneHint  = { fontSize: '0.75rem', color: '#94a3b8' };

export const filePreviewContainer = { marginTop: '0.8rem', display: 'flex', flexWrap: 'wrap', gap: '0.5rem' };
export const filePreviewItem      = { display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: C.surfaceAlt, borderRadius: '6px', padding: '0.3rem 0.7rem', fontSize: '0.8rem', color: C.textMuted };
...
export const statusBadge          = (estado) => ({ backgroundColor: (coloresEstado[estado] ?? coloresEstado.CERRADO).bg, color: (coloresEstado[estado] ?? coloresEstado.CERRADO).text, padding: '0.25rem 0.75rem', borderRadius: '999px', fontSize: '0.8rem', fontWeight: 600 });
export const assignButton         = { backgroundColor: C.blue, color: '#fff', border: 'none', padding: '0.35rem 0.9rem', borderRadius: '6px', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer' };

export const modalOverlay       = { position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 };
export const modalContent       = { backgroundColor: C.surface, borderRadius: C.radius, padding: '2rem', width: '400px', boxShadow: C.shadow, border: `1px solid ${C.border}` };
...
export const modalConfirmButton = { backgroundColor: C.blue, color: '#fff', border: 'none', padding: '0.7rem 1.5rem', borderRadius: C.radiusSm, fontWeight: 600, cursor: 'pointer', flex: 1 };
export const modalCancelButton  = { backgroundColor: C.surfaceAlt, color: C.textMuted, border: `1px solid ${C.border}`, padding: '0.7rem 1.5rem', borderRadius: C.radiusSm, fontWeight: 600, cursor: 'pointer', flex: 1 };