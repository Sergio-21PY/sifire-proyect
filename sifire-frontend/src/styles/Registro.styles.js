...
export const labelOpt = { fontWeight: 400, color: '#475569', marginLeft: '0.3rem' };
...
export const alertErr = { backgroundColor: '#450a0a', color: '#f87171', padding: '0.7rem 1rem', borderRadius: C.radiusSm, fontSize: '0.85rem', textAlign: 'center', marginBottom: '1.2rem' };
