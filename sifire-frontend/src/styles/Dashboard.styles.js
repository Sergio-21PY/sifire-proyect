...
export const mainContainer = {
  minHeight: '100vh',
  backgroundColor: C.bg, padding: '2rem'
};
...
export const kpiGrid = { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '2rem' };
export const kpiCard = (color) => ({ backgroundColor: C.surface, borderRadius: C.radius, padding: '1.5rem', boxShadow: C.shadowSm, borderLeft: `4px solid ${color}` });
...
export const tableWrapper = { backgroundColor: C.surface, borderRadius: C.radius, boxShadow: C.shadowSm, overflow: 'hidden' };
export const tableHeader = { padding: '1.2rem 1.5rem', borderBottom: `1px solid ${C.border}` };
export const tableTitle = { margin: 0, fontSize: '1.1rem', fontWeight: 600, color: C.textPrimary };
